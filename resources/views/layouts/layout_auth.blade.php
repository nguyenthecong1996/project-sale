...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(xtreme/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box">
                @yield('auth_content')
            </div>
        </div>
