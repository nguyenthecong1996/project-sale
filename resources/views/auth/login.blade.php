...
<div id="loginform">
    ...
    <div class="row">
        <div class="col-12">
            <form class="form-horizontal m-t-20" id="loginform" action="{{route('login.custom')}}" method="post">
                @csrf
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1"><i class="ti-user"></i></span>
                    </div>
                    <input type="text" class="form-control form-control-lg" placeholder="Account or Email" aria-label="Username" aria-describedby="basic-addon1" name="account">
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
